...
## Larghezza, altezza e bordi del riquadro che contiene il nome del
## personaggio, oppure None per dimensionarlo automaticamente.
...
## Larghezza e altezza di un pulsante, in pixel. Se 'None', Ren'Py calcolerà
## una dimensione.
...
## Puoi aggiungere le tue personalizzazioni, aggiungendo variabili con la
## giusta nomenclatura. Per esempio, puoi togliere il segno # dalla linea
## seguente per impostare una larghezza fissa dei pulsanti di navigazione.
...
## L'altezza di un elemento nella schermata di cronologia, oppure None per
## avere altezze variabili al costo delle prestazioni.
...
## La spaziatura fra gli elementi in Modalità NVL, quando gui.nvl_height è
## None, e fra questi e un menu NVL.
