...
## il gioco.
##
## Le linee che cominciano con due '#' sono commenti e non dovresti
## modificarle. Le linee con un solo '#' sono linee di codice opzionali, e
## potresti volerle modificare se appropriato.


## Fondamentali ################################################################

## Il nome del gioco in forma leggibile. E' usato per il titolo nella finestra
## e viene impiegato per i resoconti di errore e nell'interfaccia.
##
## La notazione _() che racchiude la stringa la segna come testo traducibile.

define config.name = _("the road")


## Determina se il titolo fornito più sopra è mostrato nel main menu. Imposta
## su 'False' per nascondere il titolo.
...
## Testo che viene inserito nella schermata informazioni del gioco. Inserisci
## il testo tra triple virgolette e lascia una riga vuota tra i paragrafi.
...
define config.save_directory = "theroad-1762699445"
