...
##
## Questa schermata si usa per mostrare renpy.input. Il parametro prompt è
## usato per fornire un prompt testuale.
##
...
##
## Il menu rapido è mostrato durante il gioco per fornire accesso facile ai
## menu esterni.
...
##
## Lo screen preferences (Opzioni) consente al giocatore di configurare il
## gioco per un'esperienza più affine ai suoi gusti.
##
    ...
    use game_menu(_("Opzioni"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                ## Vbox addizionali del tipo "radio_pref" o "check_pref"
                ## possono venire aggiunti qui, per offrire ulteriori opzioni al
                ## giocatore.
...
## Dato che un mouse non è presente, rimpiazziamo il quick menu con una
## versione che usa meno pulsanti e più grandi, più facili da toccare.
screen quick_menu():
    variant "touch"
